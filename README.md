...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wild-block-5160
```

A live public deployment of this template is available at [https://wild-block-5160.templates.workers.dev](https://wild-block-5160.templates.workers.dev)
